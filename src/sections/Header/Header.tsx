        ...
        <Disclosure as="nav" className="container px-5 md:px-8 xl:px-8">
          {({ open }) => (
            <>
              ...
              <Disclosure.Panel
                className={`h-[calc(100vh-83px)] overflow-y-auto z-20 pb-[41px] pt-[60px] md:pt-[110px] md:pb-[90px] absolute hero-bg bg-center xl:hidden bg-lightWite left-0 right-0 top-full  mt-[1px] w-screen ${
                  open ? '' : 'hidden'
                }`}
              >
                {({ open, close }) => (
