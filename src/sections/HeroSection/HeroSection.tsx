      ...
      <Element name="main">
        <div className="container flex flex-col items-center md:flex-row md:justify-between xl:justify-start">
          <div className="mb-[60px] md:mb-0 xl:mr-[134px]">
            ...
            <p className="max-w-[280px] s:max-w-[300px] md:max-w-[336px] xl:max-w-[488px] mb-[28px] md:mb-[40px] xl:mb-[57px] text-black text-[18px]/[28px] md:text-[20px]/[28px]">
              {descriptionText}
            </p>
          ...
          <Image
            src={mainImage}
            alt={imageAltText}
            width={less480px ? 280 : bigger1280px ? 488 : 330}
            height={less480px ? 307 : bigger1280px ? 543 : 368}
          />
        </div>
      </Element>
    </section>
