...
function ProductCard(props: IProduct) {
  ...
  return (
    <li className="md:place-self-stretch max-md:mx-auto max-md:mb-[32px] relative px-5 md:px-8 bg-lightWite text-center pt-[214px] pb-5 md:pb-8 xl:pb-10 min-h-[508px] s:min-h-[462px] md:min-h-[472px] xl:min-h-[456px] w-[280px] s:w-[300px] md:w-[336px] xl:w-[384px] rounded-t-[200px] border border-purple-80">
